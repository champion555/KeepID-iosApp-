        ...
        request(urlPart: Constants.URLPart.photoLivenessCheck.rawValue, token: token, photoFilePath: photoFilename, completion: { error, response in
            ...
            if error != nil{
                ...
                if statusCode == "200"{
                    ...
                    if result > 0 {
                        if self.photoFaceLiveness == true && self.userSettingProfile == false {
                        ...
                        }else if self.photoFaceLiveness == true && self.userSettingProfile == true {
                            DispatchQueue.main.async {
                                self.processingView.isHidden = true

//
//  KYCCreatePINViewController.swift
//  VeriFace
//
...
class KYCCreatePINViewController: UIViewController,UITextFieldDelegate {
    ...
    func configureView(){
        btnCreatePIN.layer.cornerRadius = 5
    ...
    @IBAction func onCreatePIN(_ sender: Any) {
        ...
        if otpCode.count == 0 {
            CommonManager.shared.showAlert(viewCtrl: self, title: "Warning", msg: "Please enter  the Pin Code")
            return
        }
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "KYCConfirmPINViewController") as! KYCConfirmPINViewController

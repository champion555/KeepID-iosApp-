    ...
    func cropImage(_ inputImage: UIImage) -> UIImage?
    {
        ...
        if !FileManager.default.fileExists(atPath: fileURL.path) {
            do {
                ...
                print("file saved")
                if IdType == "FrontIDCard"{
//                    Constants.FrontIDDocPath = fileURL.path
//                    UserDefaults.standard.set(fileURL.path, forKey: "IDCardFrontPath")
                    AppUtils.savetoUserDefaults(value: fileURL.absoluteString, key: "IDCardFrontPath")
...
//                    Constants.BackIDDocPath = fileURL.path
//                    UserDefaults.standard.set(fileURL.path, forKey: "IDCardBackPath")
                    AppUtils.savetoUserDefaults(value: fileURL.absoluteString, key: "IDCardBackPath")
                    let vc = self.storyboard?.instantiateViewController(withIdentifier: "KYCSettingIDCardViewController") as! KYCSettingIDCardViewController
                    self.navigationController?.pushViewController(vc, animated: true)
                }
                if IdType == "FrontDriving"{
//                    Constants.FrontIDDocPath = fileURL.path
//                    UserDefaults.standard.set(fileURL.path, forKey: "DrivingFrontPath")
                    AppUtils.savetoUserDefaults(value: fileURL.absoluteString, key: "DrivingFrontPath")
...
//                    Constants.BackIDDocPath = fileURL.path
//                    UserDefaults.standard.set(fileURL.path, forKey: "DrivingBackPath")
                    AppUtils.savetoUserDefaults(value: fileURL.absoluteString, key: "DrivingBackPath")
                    let vc = self.storyboard?.instantiateViewController(withIdentifier: "KYCSettingDrivingViewController") as! KYCSettingDrivingViewController
                    self.navigationController?.pushViewController(vc, animated: true)
                }
                if IdType == "FrontResident"{
//                    Constants.FrontIDDocPath = fileURL.path
//                    UserDefaults.standard.set(fileURL.path, forKey: "ResidentFrontPath")
                    AppUtils.savetoUserDefaults(value: fileURL.absoluteString, key: "ResidentFrontPath")
...
//                    Constants.BackIDDocPath = fileURL.path
//                    UserDefaults.standard.set(fileURL.path, forKey: "ResidentBackPath")
                    AppUtils.savetoUserDefaults(value: fileURL.absoluteString, key: "ResidentBackPath")
                    let vc = self.storyboard?.instantiateViewController(withIdentifier: "KYCSettingResidentViewController") as! KYCSettingResidentViewController
                    self.navigationController?.pushViewController(vc, animated: true)
                }
                if IdType == "Passport"{
//                    Constants.FrontIDDocPath = fileURL.path
//                    UserDefaults.standard.set(fileURL.path, forKey: "PassportPath")
                    AppUtils.savetoUserDefaults(value: fileURL.absoluteString, key: "PassportPath")
